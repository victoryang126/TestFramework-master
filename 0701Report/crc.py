...
class CRC:
    ...
    @staticmethod
    def calculate_crc(data, polynomial, initial_value=0xFFFFFFFF, final_xor=0xFFFFFFFF, width=32, input_reflect=False, result_reflect=False):
        crc = initial_value
    ...
    @staticmethod
    def calculate_crc_with_table(data, crc_table, crc_initial, final_xor, width=32, input_reflect=False, result_reflect=False):
        crc = crc_initial
...
if __name__ == "__main__":
    ...
    CRC.calculate_crc_with_table(bytearray([0x31,0x32,0x33]),crc_table,0x1D,0xFF,0xFF,8)
