...
class HTMLReport:
    ...
    def test_step_eq(self, action:str, expect:Any, actual:Any):
        ...
        log = TestLog.get_f_back_log(1, action, "\n".join(explanation))  # get the back_log
    ...
    def test_step_aria(self, aria_function_return,expect = None):
        ...
        if len(aria_function_return) !=4 and isinstance(aria_function_return) != List:
            ...
            result = False
            log = TestLog.get_f_back_log(1,f"the return value of aria function shall be a list with 4 element")
        elif expect == None:
            ...
            log = TestLog.get_f_back_log(1,action) #get the back_log
        else:
