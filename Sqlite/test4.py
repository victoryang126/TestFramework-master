...
class DictionaryToTable(QMainWindow):
    ...
    def print_preview(self):
        printer = QPrinter()
        preview_widget = QPrintPreviewWidget(printer, self)
        preview_widget.paintRequested.connect(self.print_table)

        preview_dialog = QMainWindow()
        preview_dialog.setCentralWidget(preview_widget)
